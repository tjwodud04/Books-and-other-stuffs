#https://opentutorials.org/course/3186/17973
...
button_div = ttk.Button(root, text="/", command=lambda:button_pressed('/'))
...
button_add = ttk.Button(root, text="+", command=lambda:button_pressed('+'))
...
button_equal = ttk.Button(root, text="=", command=lambda:button_pressed('='))
button_equal.grid(row=4, column=2)
button_sub = ttk.Button(root, text="-", command=lambda:button_pressed('-'))
