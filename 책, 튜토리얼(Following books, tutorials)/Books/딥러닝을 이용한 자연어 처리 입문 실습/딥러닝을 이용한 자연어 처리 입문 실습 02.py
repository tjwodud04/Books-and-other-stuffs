...
딥러닝을 이용한 자연어 처리 입문
4)불용어(한글 부분 추가 예정) 5)정규 표현식(책 보충 예정) 6)단어 분리(책이 미완)
'''
...
text6 = """100 Jonhn    PROF
101 James   STUD
101 MAC   STUD"""
print(re.split('\s+', text6))
print(re.findall('\d+',text6))
print(re.findall('[A-Z][a-z]+',text6))
letters_only = re.sub('[^a-zA-Z]', ' ', text6)
print(letters_only)
