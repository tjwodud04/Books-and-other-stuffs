...
img_player = [
    tkinter.PhotoImage(file="img/dora0.png"),
    tkinter.PhotoImage(file="img/dora1.png")
]
img_enemy = tkinter.PhotoImage(file="img/fun.png")
img_bg = tkinter.PhotoImage(file="img/building.png")
