...
def download_and_read(dataset_dir, num_pairs=None):
    ...
    with open(sent_filename, "r", encoding="utf-8") as fsent:
    ...
    with open(poss_filename, "r", encoding="utf-8") as fposs:
...
for input_b, output_b in train_dataset.take(1):
    ...
    print("in:", input_b.shape, "label:", output_b.shape, "prediction:", pred_b.shape)

num_epochs = NUM_EPOCHS

best_model_file = os.path.join(data_dir, "checkpoints/best_model.h5")
